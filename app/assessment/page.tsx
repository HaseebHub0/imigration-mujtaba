    ...
    <div className="min-h-screen">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#f5a101]">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl text-[#00537b]">CRS Score Calculator</CardTitle>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#f5a101]">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl text-[#00537b]">PNP Assessment</CardTitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">How Our Assessments Work</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Answer Questions</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Get Results</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Next Steps</h3>
                <p className="text-gray-700 text-sm">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Need Help with Your Assessment?</h2>
