...
export default function PNPAssessmentPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-cover bg-center bg-no-repeat py-20" style={{ backgroundImage: 'url("/images/herobanners/7.png")' }}>
                ...
                <div className="mt-8 text-center">
                  <Card className="bg-[#e8eaed] border-[#6aad81]">
                    <CardContent className="p-6">
                      ...
                      <Button className="bg-[#6aad81] hover:bg-[#6aad81]/90 text-white">Book Free Consultation</Button>
                    </CardContent>
                  </Card>
                </div>
              </div>
