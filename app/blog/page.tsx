  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Featured Article</h2>
            </div>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-4 mb-4">
                    <Badge className="bg-[#2e8f7c] text-white">{featuredPost.category}</Badge>
                  ...
                  <h3 className="text-2xl font-bold text-[#17203d] mb-4">{featuredPost.title}</h3>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {categories.map((category) => (
                <Button
                  ...
                  className={
                    category === "All"
                      ? "bg-[#2e8f7c] hover:bg-[#2e8f7c]/90 text-white"
                      : "border-[#2e8f7c] text-[#2e8f7c] hover:bg-[#2e8f7c] hover:text-white"
                  }
                >
                  {category}
                </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
              ...
              {blogPosts.map((post, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300 overflow-hidden">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-lg text-[#17203d] line-clamp-2">{post.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
            ...
            <div className="text-center mt-12">
              <Button className="bg-[#2e8f7c] hover:bg-[#2e8f7c]/90 text-white">Load More Articles</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#17203d] mb-4">Stay Updated</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <Button className="bg-[#2e8f7c] hover:bg-[#2e8f7c]/90 text-white">Subscribe</Button>
            </div>
