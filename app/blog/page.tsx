  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Featured Article</h2>
            </div>
            ...
            <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8">
                  ...
                  <h3 className="text-2xl font-bold text-[#00537b] mb-4">{featuredPost.title}</h3>
              ...
              {blogPosts.map((post, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300 overflow-hidden">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-lg text-[#00537b] line-clamp-2">{post.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#00537b] mb-4">Stay Updated</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Have Questions About Our Articles?</h2>
