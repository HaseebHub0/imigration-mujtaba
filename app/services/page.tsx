...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-cover bg-center bg-no-repeat py-20" style={{ backgroundImage: 'url("/images/herobanners/2.png")' }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge variant="secondary" className="bg-[#6aad81] text-white px-4 py-2">
                80% Success Rate
              </Badge>
              <Badge variant="secondary" className="bg-[#6aad81] text-white px-4 py-2">
                Free Consultation
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#144d5e] mb-4">Permanent Residency Services</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {permanentResidencyServices.map((service, index) => (
                <Card key={index} className="hover:bg-white transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#144d5e]">{service.title}</CardTitle>
              ...
              {statusServices.map((service, index) => (
                <Card key={index} className="hover:bg-[#e8eaed] transition-colors duration-300">
                  <CardHeader>
                    ...
                    <div className="text-xl font-bold text-[#6aad81]">{service.price}</div>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-1 mb-4">
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center gap-2">
                          <CheckCircle className="w-3 h-3 text-[#6aad81]" />
                          <span className="text-gray-700 text-sm">{feature}</span>
                        </li>
                      ))}
                    </ul>
                    <Button size="sm" className="w-full bg-[#6aad81] hover:bg-[#6aad81]/90 text-white">
                      Learn More
                    </Button>
                  </CardContent>
                </Card>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#144d5e] mb-2">Personalized Approach</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#144d5e] mb-2">Proven Success</h3>
                <p className="text-gray-700">
                  80% success rate with transparent assessment - we only take cases we can win.
                </p>
              </div>
              <div className="text-center">
                <Heart className="w-12 h-12 text-[#6aad81] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-[#144d5e] mb-2">Ongoing Support</h3>
                <p className="text-gray-700">
