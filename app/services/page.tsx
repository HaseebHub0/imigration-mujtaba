    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Badge variant="secondary" className="bg-[#2e8f7c] text-white px-4 py-2">
                80% Success Rate
              </Badge>
              <Badge variant="secondary" className="bg-[#2e8f7c] text-white px-4 py-2">
                Free Consultation
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#2e8f7c]">
                <CardHeader className="text-center pb-4">
                  <Globe className="w-16 h-16 text-[#2e8f7c] mx-auto mb-4" />
                  <CardTitle className="text-2xl text-[#17203d]">Permanent Residency</CardTitle>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#2e8f7c]">
                <CardHeader className="text-center pb-4">
                  <FileText className="w-16 h-16 text-[#2e8f7c] mx-auto mb-4" />
                  <CardTitle className="text-2xl text-[#17203d]">Status Services</CardTitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Permanent Residency Services</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {permanentResidencyServices.map((service, index) => (
                <Card key={index} className="hover:bg-white transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#17203d]">{service.title}</CardTitle>
                    <p className="text-gray-600">{service.description}</p>
                    <div className="text-2xl font-bold text-[#2e8f7c]">{service.price}</div>
                  </CardHeader>
                  <CardContent>
                    ...
                    <Button className="w-full bg-[#2e8f7c] hover:bg-[#2e8f7c]/90 text-white">Get Started</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Status Services</h2>
              <p className="text-gray-700 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {statusServices.map((service, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-lg text-[#17203d]">{service.title}</CardTitle>
                    <p className="text-gray-600 text-sm">{service.description}</p>
                    <div className="text-xl font-bold text-[#2e8f7c]">{service.price}</div>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-1 mb-4">
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center gap-2">
                          <CheckCircle className="w-3 h-3 text-[#2e8f7c]" />
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#17203d] mb-8">Why Choose Our Services?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <Users className="w-12 h-12 text-[#2e8f7c] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-[#17203d] mb-2">Personalized Approach</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#17203d] mb-2">Proven Success</h3>
                <p className="text-gray-700">
                  80% success rate with transparent assessment - we only take cases we can win.
                </p>
              </div>
              <div className="text-center">
                <Heart className="w-12 h-12 text-[#2e8f7c] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-[#17203d] mb-2">Ongoing Support</h3>
                <p className="text-gray-700">
