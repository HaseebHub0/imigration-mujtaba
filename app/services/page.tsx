    ...
    <div className="min-h-screen">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#f5a101]">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl text-[#00537b]">Permanent Residency</CardTitle>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 border-2 border-[#f5a101]">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl text-[#00537b]">Status Services</CardTitle>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Permanent Residency Services</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {permanentResidencyServices.map((service, index) => (
                <Card key={index} className="hover:bg-white transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#00537b]">{service.title}</CardTitle>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Status Services</h2>
              <p className="text-gray-700 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {statusServices.map((service, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-lg text-[#00537b]">{service.title}</CardTitle>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#00537b] mb-8">Why Choose Our Services?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <Users className="w-12 h-12 text-[#f5a101] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-[#00537b] mb-2">Personalized Approach</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#00537b] mb-2">Proven Success</h3>
                <p className="text-gray-700">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#00537b] mb-2">Ongoing Support</h3>
                <p className="text-gray-700">
