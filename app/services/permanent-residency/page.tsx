    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Immigration Programs</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {programs.map((program, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#00537b]">{program.title}</CardTitle>
                  ...
                  <CardContent>
                    <h4 className="font-semibold text-[#00537b] mb-3">Minimum Requirements:</h4>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Our PR Process</h2>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Assessment</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Strategy</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Preparation</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#00537b] mb-2">Success</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Why Choose Our PR Services?</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#00537b] mb-3">CRS Optimization</h3>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#00537b] mb-3">Family Support</h3>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#00537b] mb-3">Expert Guidance</h3>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00537b] mb-4">Get Started with Permanent Residency</h2>
              <p className="text-gray-700 max-w-2xl mx-auto">
