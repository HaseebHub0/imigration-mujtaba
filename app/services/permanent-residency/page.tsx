...
import { CheckCircle, Globe, TrendingUp, Users, Award } from "lucide-react"
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Immigration Programs</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {programs.map((program, index) => (
                <Card key={index} className="hover:bg-[#f5f2ec] transition-colors duration-300">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#17203d]">{program.title}</CardTitle>
                    <p className="text-gray-600">{program.description}</p>
                    <div className="flex justify-between items-center">
                      <span className="text-2xl font-bold text-[#2e8f7c]">{program.price}</span>
                      <Badge variant="outline" className="border-[#2e8f7c] text-[#2e8f7c]">
                        {program.processingTime}
                      </Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <h4 className="font-semibold text-[#17203d] mb-3">Minimum Requirements:</h4>
                    <ul className="space-y-2 mb-6">
                      {program.minRequirements.map((req, idx) => (
                        <li key={idx} className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-[#2e8f7c] mt-0.5 flex-shrink-0" />
                          <span className="text-gray-700 text-sm">{req}</span>
                        </li>
                      ))}
                    </ul>
                    <Button className="w-full bg-[#2e8f7c] hover:bg-[#2e8f7c]/90 text-white">Get Assessment</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section className="py-16 bg-[#f5f2ec]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Our PR Process</h2>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#17203d] mb-2">Assessment</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#17203d] mb-2">Strategy</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#17203d] mb-2">Preparation</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#17203d] mb-2">Success</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#17203d] mb-4">Why Choose Our PR Services?</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  <TrendingUp className="w-12 h-12 text-[#2e8f7c] mx-auto mb-4" />
                  <h3 className="text-xl font-semibold text-[#17203d] mb-3">CRS Optimization</h3>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#17203d] mb-3">Family Support</h3>
              ...
              <Card className="hover:bg-[#f5f2ec] transition-colors duration-300 text-center">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#17203d] mb-3">Expert Guidance</h3>
